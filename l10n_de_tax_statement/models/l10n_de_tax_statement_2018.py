...
def _tax_statement_dict_2018():
    return {
        ...
        "21": {
            "code": "21",
            "base": 0.0,
            "name": _lt("... neue Fahrzeuge an Abnehmer ohne UST-ID (44)"),
        },
        "22": {
            "code": "22",
            "base": 0.0,
        ...
        "37": {
            ...
            "base": 0.0,
            "tax": 0.0,
            "name": _lt("Ergänzende Angaben zu Umsätzen"),
        },
        "38": {
            "code": "38",
            "base": 0.0,
        ...
        "53": {"code": "53", "tax": 0.0, "name": _lt("Umsatzsteuer")},
        "54": {"code": "54", "name": _lt("Abziehbare Vorsteuerbeträge")},
        "55": {
            "code": "55",
            "tax": 0.0,
            "name": _lt(
